...
<html lang="es">
    ...
    <body>
        ...
        <div class="libro">
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sequi minus asperiores recusandae 
                mollitia officia deleniti error in voluptatibus corporis excepturi obcaecati adipisci tempore, 
                maxime repellendus laborum inventore consectetur veritatis nulla!
            </p>
        </div>
        <div class="listado">
            <ul>
