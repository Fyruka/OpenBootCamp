    ...
    <head>
        ...
        <style>
            ...
            .contenedor-scroll-x {
                ...
                overflow-x: hidden;
                overflow-y: scroll;
                /* overflow-x o y, es un atributo que solo afecta a esos ejes de tal manera que podemos actuar 
                como el auto que coloca la barra de scroll solo en el eje que nosotros queremos.
