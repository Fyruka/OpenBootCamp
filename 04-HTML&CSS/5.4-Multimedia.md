    ...
    <head>
        ...
        <style>
            ...
            * {
            ...
            .imagen-principal {
                /* VW es una unidad de medida de CSS que significa Viewport Wirdth, y lo que hace es recoge el 100% en este caso 
                del ancho del navegador, en las imagenes tenemos que contar que CSS siempre intenta mantener la relacion de aspecto, 
                si solo le especificamos un eje */
                width: 100vw;
            ...
            /* Esta funcion la veremos en las siguientes clases pero significa que cuando colocamos el cursor encima de la 
            imagen aplica este estilo, y si quitamos el cursor vuelve a aplicar el anterior */
