    ...
    <head>
        ...
        <style>
            .flex {
                ...
                /* flex-direction hace que podamos cambiar el orden en los ejes o incluso el eje principal.
                 Al cambiar el eje principal hacemos tambien que justify-content y align-items cambien sus funciones.  */
                /* Por defecto es row */
                ...
                /* Posiciona el contenido en el eje vertical dentro del contenedor, al igual que Justify-Content tenemos muchos atributos, 
                por default esta en stretch */
                ...
                /* Existe una opcion que es el wrap, en NOWRAP hace resize de los elementos, en WRAP no hace resize sino 
                que cambia de linia los elementos para mantener el tamaño*/
                flex-wrap: nowrap;
            }
