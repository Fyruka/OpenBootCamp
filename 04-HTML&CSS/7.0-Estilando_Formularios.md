    ...
    <head>
        ...
        <style>
            ...
            * {
            ...
            /* Con este metodo de seleccion para formularios podemos seleccionar los campos por atributo, 
            en este caso seleccionamos unicamente los de type=password. */
            .input[type="password"] {
                color: red;
            }
            ...
            /* La pseudo-clase focus no dice que cuando estamos con el enfoque dentro de un input o elemento, 
            se activen los estilos, y cuando no, se desactiven, como en el hover.  */
            .input-moderno:focus {
