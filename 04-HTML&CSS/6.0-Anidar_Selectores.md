...
<html lang="en">
    <head>
        ...
        <style>
            /* Si quisieramos acceder a todos los p (parrafos) del contenedor (contenedor) usaremos la anidacion de selectores, 
            esto significa que seleccionare contenedor y luego lo que quiera seleccionar */
            .contenedor p {
                color: green;
            }
